...
const Card2 = ({
  ...
  return (
    <div
      className="h-full w-[400px] max-md:w-[350px] max-sm:w-[325px] rounded-2xl object-contain relative transition-all duration-300 hover:scale-[1.03] hover:shadow-4xl cursor-pointer"
      style={{
    ...
    >
      ...
      />
      <div className="absolute top-2 m-3 px-4 max-md:py-2 py-5">
