const footerContent = [
  ...
  <>Representative example: <br /> A purchase of ₹79900.00 repaid over 12 months with an interest rate of 15.99% p.a. requires monthly payments of ₹7249.00. Total amount payable: ₹86988.00. Total interest paid to bank: ₹7088.00.</>,
  ...
  <>Representative example: <br /> A purchase of ₹79900.00 repaid over 12 months with an interest rate of 15.99% p.a. and No Cost EMI savings of ₹6514.00 requires monthly payments of ₹6658.00. Total amount payable: ₹79900.00.</>,
...
const Footer = () => {
  return (
    <footer className="bg-gray-100 text-xs text-gray-600 px-4 py-6 md:px-20 md:py-10">
      <div className="space-y-4 max-w-5xl mx-auto">
        {footerContent.map((item, index) => (
          <p
            key={index}
            className={index === 8 ? "text-[11px]" : undefined}
          >
            {item}
            {index === 3 && (
