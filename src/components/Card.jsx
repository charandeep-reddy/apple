function Card({ tag, title, description, image, textColor = "#1D1D1F", width }) {
  const customStyle = width ? { backgroundImage: `url(${image})`, width } : { backgroundImage: `url(${image})` };
  ...
  <div className="pb-[8px] min-h-[18px]">{tag}</div>
        ...
        <h2
          className="text-apple-black font-semibold text-[26px] leading-8 font-apple-display tracking-small"
